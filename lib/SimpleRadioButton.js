    ...
    return (
      <View style={this.props.buttonWrapStyle} >
        <TouchableOpacity
          ...
          <View style={{ position: 'absolute', width: outerSize.width + borderWidth, height: outerSize.height + borderWidth, top: 0, left: 0, justifyContent: 'center', alignItems: 'center'}}>
            {c}
          </View>
        </TouchableOpacity>
      </View>
