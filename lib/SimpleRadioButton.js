...
export class RadioButtonInput extends React.Component {
  ...
  render () {
    ...
    const isOld = Platform.Version < 23 ? true : false;
    ...
    return (
      <View style={this.props.buttonWrapStyle} >
        <TouchableOpacity
          ...
          onPress={() => { this.props.onPress( this.props.obj.value, this.props.index) }}>
          { isOld ? (
            <ART.Surface width={outerSize.width} height={outerSize.height}>
              <ART.Group x={3} y={3}>
                <Circle radius={(outerSize.width - borderWidth * 2.5) / 2} stroke={outerColor} strokeWidth={borderWidth}/>
              </ART.Group>
            </ART.Surface>
          ) : (
            <View style={{
              ...
              borderRadius: outerSize.width/2,
          ...
          <View style={{
            position: 'absolute',
            width: isOld ? (outerSize.width + borderWidth) : outerSize.width,
            height: isOld ? (outerSize.height + borderWidth) : outerSize.height,
    ...
    return (
      <TouchableWithoutFeedback
        ...
        <View style={[
          ...
          ]}>{this.props.obj[this.props.keyText]}</Text>
        </View>
      </TouchableWithoutFeedback>
    )
  }
